...
- (1) clone the repository to your Github account or (2) save the zip file.
- Store the files in an RStudio project environment using the alpha-3 letter code of the country of interest.
