---
title: "Add a new crop in GLOBIOM"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Add a new crop in GLOBIOM}
...
Data_crops_’countryname’.gms
DData('IndonesiaReg',CROPS,'PriceEla')
 $ (DData('IndonesiaReg',CROPS,'Quantity')  AND
    (DData('IndonesiaReg',CROPS,'PriceEla') eq 0) )
  = DemandPriceEla_USDA('IndonesiaReg','Cccoa') ;
```
