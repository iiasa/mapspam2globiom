...
To process the spatial data, simply run the various scripts in the `03_spatial_data` folder. As the scripts can be run in any order, they do not have a number such as most scripts in the other folders. Note that some of the scripts, in particular `select_gaez.r`, which processes more than 300! global maps, can take some time to run. 
