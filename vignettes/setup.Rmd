...
Nearly all functions in mapspam2globiom need input on (1) key parameters that determine the design of the model and how it is solved and (2) the location of files that are processed so they can be used as input in the next step. 
